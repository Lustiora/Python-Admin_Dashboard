class Search:
    ...
    first_view_query\
        ...
        SELECT 
            ...
            COUNT(ur.rental_id) FILTER (WHERE ur.return_date IS NULL) ||' / '|| COUNT(DISTINCT i.inventory_id) as inventory
        FROM inventory i
    ...
    film_title_tag_query\
        ...
        inner join film f on i.film_id = f.film_id
        where i.store_id = %s
        and f.fulltext @@ to_tsquery('english', %s)
        """
