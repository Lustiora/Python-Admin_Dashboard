...
# -- Module --
def run_main(page: flet.Page, conn, staff_user, staff_store_address, staff_store_id, config, config_file):
    ...
    main_handler = MainManager(page=page, conn=conn, staff_user=staff_user,
                               staff_store_address=staff_store_address, staff_store_id=staff_store_id, config=config, config_file=config_file)
