...
def view_search_customer(customer_name=None, **kwargs):
    ...
    return flet.Column(
        controls=[
            ...
            flet.Column([view_container(view_customer)], expand=True),
        ], spacing=20
    )
...
def view_search_inventory(**kwargs):
    ...
    return flet.Column(
        controls=[
            ...
            flet.Column([view_container(view_inventory)], expand=True),
        ], spacing=20
    )
    ...
    return flet.Row([
        flet.Column(
            controls=[
                ...
                flet.Column([view_container(view_rental)], expand=True),
            ], expand=5, spacing=20
        ),
        rental_history
    ], spacing=20)
    ...
    return flet.Row([
        flet.Column(
            controls=[
                ...
                flet.Column([view_container(view_payment)], expand=True),
            ], expand=5, spacing=20
        ),
        receipt_details
    ], spacing=20)
