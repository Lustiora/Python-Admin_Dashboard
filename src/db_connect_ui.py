...
class DBConnect:
    def __init__(self, page: flet.Page, popup: Popup):
        ...
        if self.config.read(self.config_file):
            self.user_theme = self.config['Theme']['theme']
